...
public class TimerWidget extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        // Overwrite saved prefs for state, since they may represent
        // a previous, no longer valid state. Better to assume the timer is not running.
        saveTimerState(context, false, false);
        loadTimerState(context); // required for accessing startingSeconds
